...
/*
 * cwiid Compatibility
 * CWiid compatibility layer. We directly support binary compatibility to the
 * cwiid library.
 *
 * To use this as drop-in replacement for libcwiid you should rename this header
 * to cwiid.h and symlink libcwiid.so to the lib.
 */

/*
 * Original CWiid Copyright:
 *
